...
author: "CLAUDIO, Mauricio" extended by "Vicky McEleney"
date: "Due Date: 2021-11-26"
output:
...
## Heatmap of 2d bin counts plot (This is a useful alternative to geom_point() in the presence of overplotting.)

```{r, warning=FALSE, message=FALSE}
ggplot(cotw, ## Specify data source
       aes(x=GDP....per.capita., ## Specify x-axis variable
                y=Infant.mortality..per.1000.births.)) + ## Specify y-axis variable
  geom_bin_2d(bins = 30) + ## Specifiy 'heatmap of 2d bin counts' plot
  xlab("GDP / capita") + ## Specify x-axis label
  ylab("Infant Mortality / 1000 births") ## Specify y-axis label
```
